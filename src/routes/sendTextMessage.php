...
$app->post('/api/Viber/sendTextMessage', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['token','receiver','text','senderName']);
    ...
    $requiredParams = ['token'=>'token','receiver'=>'receiver','text'=>'text','senderName'=>'senderName'];
    $optionalParams = ['senderAvatar'=>'senderAvatar','trackingData'=>'tracking_data','minApiVersion'=>'min_api_version'];
    $bodyParams = [
       'json' => ['receiver','min_api_version','sender','tracking_data','text', 'type']
    ];

...
$app->post('/api/Viber/sendUrl', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['token','receiver','media','senderName']);
    ...
    $requiredParams = ['token'=>'token','receiver'=>'receiver','media'=>'media','senderName'=>'senderName'];
    $optionalParams = ['senderAvatar'=>'senderAvatar','trackingData'=>'tracking_data','minApiVersion'=>'min_api_version'];
    $bodyParams = [
       'json' => ['receiver','min_api_version','sender','tracking_data','media','type']
    ];
